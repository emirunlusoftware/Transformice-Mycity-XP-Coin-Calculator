...
{
	SetWindowText(EnterLvl1, L"");
	SetWindowText(EnterXp1, L"");
...
void DiffLevelPage(bool isVisible)
{
	SetWindowText(EnterLvl1, L"");
	SetWindowText(EnterXp1, L"");
	SetWindowText(EnterLvl2, L"");
	SetWindowText(EnterXp2, L"");
